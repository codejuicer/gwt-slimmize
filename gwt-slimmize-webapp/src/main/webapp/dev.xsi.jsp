...
<link rel="import" href="elements/wunit-log.html">
     ...
     <script src="dev-mode/wunit_logic_xsi/wunit_logic_xsi.nocache.js"></script>
...
<body>	
	...
	<div class="container">
		...
		<wunit-unit id="unit-a" name="">
		</wunit-unit>
		<wunit-unit id="unit-b" name="">
		</wunit-unit>

		<wunit-game id="game-status" current-distance="">
		</wunit-game>
